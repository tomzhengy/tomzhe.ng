...
export default function MosaicGrid({
  ...
  return (
    <div className="flex gap-8">
      {/* left: text panel */}
      <div className="hidden md:block w-[200px] shrink-0 self-start sticky top-[8vh] h-[calc(100vh-8vh)]">
      ...
      <div className="flex-1 relative">
        ...
        {selectedItem && (
          <>
            ...
            >
              {/* left: text panel */}
              <div className="hidden md:flex max-w-[200px] min-w-0 shrink flex-col justify-center px-4 break-words overflow-hidden">
