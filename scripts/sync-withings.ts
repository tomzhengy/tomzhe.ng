...
// meastype codes we care about. matches WITHINGS_TYPE_TO_COLUMN in
// app/lib/health-archive.ts:
//   1=weight, 4=height, 5=fat-free mass, 6=fat ratio, 8=fat mass,
//   11=heart rate, 76=muscle mass, 77=hydration, 88=bone mass,
//   91=pulse wave velocity, 155=vascular age, 168=extracellular water,
//   169=intracellular water, 170=visceral fat, 226=basal metabolic rate.
const MEASTYPES = "1,4,5,6,8,11,76,77,88,91,155,168,169,170,226";
